...
Cheddar Bae Biscuits is a single page app I built using the Google Maps API and the [Edamam recipe API](https://developer.edamam.com/) to give Cheddar Bay Biscuits the spotlight they deserve.
...
[See it on GitHub Pages](https://samanthasheadavis.github.io/apiSite/#home-template)
#### Languages/Tools
* JavaScript
* JQuery
* HTML5
